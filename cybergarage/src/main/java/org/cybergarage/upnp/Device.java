...
public class Device implements org.cybergarage.http.HTTPRequestListener,
    ...
    public boolean postSearchResponse(SSDPPacket ssdpPacket, String st,
        ...
        KLog.d("remoteAddr = " + remoteAddr);
        KLog.d(ssdpRes.toString());
...
//        KLog.d("receive ssdp packet:\n" + ssdpPacket.toString());
    ...
    private void httpGetRequestRecieved(HTTPRequest httpReq) {
        ...
        KLog.d("httpGetRequestRecieved = " + uri);
        if (uri == null) {
            httpReq.returnBadRequest();
            return;
        }
...
//        KLog.d(ctlReq.toString());
    ...
    public boolean start() {
        ...
        // SSDP Seach Socket
        // 常驻服务
        // 接收239.255.255.250:1900组播消息，处理ssdp:discover的请求
        // 如果自身是rootdevice,则响应http/200(可以获取到请求的IP，直接定向发送而不是组播发送)
        // 注意：自己发出的notify消息也能在这里收到
        // //////////////////////////////////////
        ...
        // //////////////////////////////////////
        // Announce
        // 向组播发送notify消息，device和每个service都发送一次
        // //////////////////////////////////////
